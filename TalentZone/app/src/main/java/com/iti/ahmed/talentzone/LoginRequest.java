...
public class LoginRequest extends StringRequest{
    ...
    private static final String REGISTER_REQUEST_URL = "http://172.16.2.4:8084//TalentZoneTom/rest/talent/login";
    private Map<String , String> params;

    public LoginRequest(String mobile,String pass,Response.Listener<String> listener)
    {
