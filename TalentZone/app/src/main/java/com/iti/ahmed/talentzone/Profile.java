...
public class Profile extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        u=(UserBean)bundle.getSerializable("value");

        NavigationView navigationView1 = (NavigationView) findViewById(R.id.nav_view);
        navigationView1.setNavigationItemSelectedListener(this);
        View header=navigationView1.getHeaderView(0);
        txt= (TextView) header.findViewById(R.id.txtNav_name);
        txt.setText(u.getFirst_name() +" " + u.getLast_name());

        //txt.setText("mmmm");
        setTitle("Home");
        // set initial frahment
        Home home = new Home();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camara) {
            ...
            EditProfile myProfile = new EditProfile();
            android.support.v4.app.FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransaction.replace(R.id.fragment_container,myProfile);
            fragmentTransaction.commit();
